...
export function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-[210] bg-ivory md:bg-ivory/95 md:backdrop-blur-sm border-b border-teal/5 shadow-[0_1px_0_rgba(13,59,63,0.04)]">
      <nav
      ...
      >
        <Link
          href="/"
          className="relative z-[210] font-serif text-xl md:text-2xl text-teal hover:text-teal-light transition-colors"
        >
          {SITE_NAME}
        </Link>
